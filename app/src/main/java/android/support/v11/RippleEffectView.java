...
/**
 * RippleEffectView custom layout
 * <p>
...
public class RippleEffectView extends RelativeLayout {
    ...
    public RippleEffectView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RippleEffectView);
        rippleColor = typedArray.getColor(R.styleable.RippleEffectView_rev_color, getResources().getColor(android.R.color.darker_gray));
        rippleType = typedArray.getInt(R.styleable.RippleEffectView_rev_type, 0);
        hasToZoom = typedArray.getBoolean(R.styleable.RippleEffectView_rev_zoom, false);
        isCentered = typedArray.getBoolean(R.styleable.RippleEffectView_rev_centered, false);
        rippleDuration = typedArray.getInteger(R.styleable.RippleEffectView_rev_rippleDuration, rippleDuration);
        frameRate = typedArray.getInteger(R.styleable.RippleEffectView_rev_frame_rate, frameRate);
        rippleAlpha = typedArray.getInteger(R.styleable.RippleEffectView_rev_alpha, rippleAlpha);
        ripplePadding = typedArray.getDimensionPixelSize(R.styleable.RippleEffectView_rev_ripplePadding, 0);
        canvasHandler = new Handler();
        zoomScale = typedArray.getFloat(R.styleable.RippleEffectView_rev_zoomScale, 1.03f);
        zoomDuration = typedArray.getInt(R.styleable.RippleEffectView_rev_zoomDuration, 200);
        typedArray.recycle();
        paint = new Paint();
    ...
    public interface OnRippleCompleteListener {
        void onComplete(RippleEffectView rippleEffectView);
    }
